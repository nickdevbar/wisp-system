                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Reporte Pagos De Mensualidad</h5>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div style="text-align:right;" class="mt-1">
                                        ...
                                        <a href="../reportes/excel/report_pagos_fec.php?fecha=<?php echo $_GET['fecha'];?>" target="_black" class="btn btn-outline-success btn-sm"> Imprimir Reporte <i class="far fa-file-excel"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive mt-3">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php $obj_factura->puntero = $obj_factura->todosPagos();
                                                    while (($fac = $obj_factura->extraer_dato()) > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $fac['nom_plan']; ?></td>
                                                            <td><?php echo $fac['mes_fac']." - ".$fac['ano_fac']; ?></td>
    ...
    <script>
        ...
        <script>
            ...
            const fecha = () => {
                ...
                if (fecha != "") {
                    location.href = 'reporte_pagos.php?fecha=' + fecha;
                } else {
                    Swal.fire(
            ...
            const todos = () => {
                location.href = 'reporte_pagos.php';
            }
        </script>
