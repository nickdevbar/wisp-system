...
$obj_man->puntero = $obj_man->listar_mantenimiento_realizado();
...
<!DOCTYPE html>
  ...
  <h4 style="vertical-align: center;" style="font-family: "Roboto Condensed", sans-serif;">Le hacemos llegar a ustedes la siguiente notificación: Mantenimiento Realizado</h4>
  ...
  Solucion = <b>' . $man["sol_act_man"] . '</b><br>
  Observacion = <b>' . $man["obs_act_man"] . '</b><br>
  Estatus = <b>' . $man["nom_est"] . '</b><br>
  Tecnico = <b>' . $man["nom_usu"] ." ". $man["ape_usu"]. '</b><br>
  <br>
...
$mail->Subject = 'Mantenimiento Realizado a  #'.$man['nom_cli'];
$mail->Body    = $mensaje;
$mail->AltBody = 'Mantenimiento Realizado...';
